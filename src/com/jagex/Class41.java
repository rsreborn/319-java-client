...
public class Class41 {
    ...
    public static void method532(Buffer buffer, Buffer class13_sub1_sub2_1, Buffer buffer_2, Buffer buffer_3) {
        method534((byte) 5, class13_sub1_sub2_1);
        method535(9, buffer_2);
        method536(buffer, (byte) 2);
        method533((byte) 6, buffer_3);
    }

    public static void method533(byte byte0, Buffer buffer) {
        try {
            if (byte0 != 6) {
            ...
            Signlink.reportError("8437, " + byte0 + ", " + buffer + ", " + runtimeexception);
        }
    ...
    public static void method534(byte byte0, Buffer buffer) {
        try {
            ...
            method537(9, aByteArrayArrayArray710, buffer, aCharArrayArray709);
            return;
        } catch (RuntimeException runtimeexception) {
            Signlink.reportError("98724, " + byte0 + ", " + buffer + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method535(int i, Buffer buffer) {
        try {
            ...
            Signlink.reportError("76838, " + i + ", " + buffer + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }

    public static void method536(Buffer buffer, byte byte0) {
        try {
            if (byte0 == 2) {
                byte0 = 0;
            } else {
            ...
            Signlink.reportError("78769, " + buffer + ", " + byte0 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method537(int i, byte[][][] abyte0, Buffer buffer, char[][] ac) {
        try {
            ...
            Signlink.reportError("68000, " + i + ", " + abyte0 + ", " + buffer + ", " + ac + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }
    ...
    public static void method538(boolean flag, Buffer buffer, char[][] ac) {
        try {
            ...
            Signlink.reportError("15617, " + flag + ", " + buffer + ", " + ac + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method539(boolean flag, char[] ac) {
        try {
            ...
            Signlink.reportError("39252, " + flag + ", " + ac + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static boolean method540(byte byte0, char c) {
        try {
            ...
            Signlink.reportError("48804, " + byte0 + ", " + c + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static String method541(boolean flag, String s) {
        try {
            ...
            Signlink.reportError("86379, " + flag + ", " + s + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method542(int i, char[] ac, char[] ac1) {
        try {
            ...
            Signlink.reportError("25217, " + i + ", " + ac + ", " + ac1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method543(char[] ac, int i) {
        try {
            ...
            Signlink.reportError("51595, " + ac + ", " + i + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method544(char[] ac, boolean flag) {
        try {
            ...
            Signlink.reportError("92183, " + ac + ", " + flag + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }
    ...
    public static void method545(char[] ac, int i) {
        try {
            ...
            Signlink.reportError("8361, " + ac + ", " + i + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method546(char[] ac, char[] ac1, char[] ac2, boolean flag, char[] ac3) {
        try {
            ...
            Signlink.reportError("50437, " + ac + ", " + ac1 + ", " + ac2 + ", " + flag + ", " + ac3 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static int method547(char[] ac, int i, byte byte0, char[] ac1) {
        try {
            ...
            Signlink.reportError("41949, " + ac + ", " + i + ", " + byte0 + ", " + ac1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static int method548(int i, char[] ac, int j, char[] ac1) {
        try {
            ...
            Signlink.reportError("77059, " + i + ", " + ac + ", " + j + ", " + ac1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method549(char[] ac, int i) {
        try {
            ...
            Signlink.reportError("96410, " + ac + ", " + i + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method550(int i, char[] ac, char[] ac1, byte byte0, char[] ac2, char[] ac3) {
        try {
            ...
            Signlink.reportError("47742, " + i + ", " + ac + ", " + ac1 + ", " + byte0 + ", " + ac2 + ", " + ac3 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static int method551(byte byte0, char[] ac, char[] ac1, int i) {
        try {
            ...
            Signlink.reportError("98967, " + byte0 + ", " + ac + ", " + ac1 + ", " + i + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static int method552(char[] ac, int i, char[] ac1, int j) {
        try {
            ...
            Signlink.reportError("76165, " + ac + ", " + i + ", " + ac1 + ", " + j + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static void method553(char[] ac, byte[][] abyte0, byte byte0, char[] ac1) {
        try {
            ...
            Signlink.reportError("18672, " + ac + ", " + abyte0 + ", " + byte0 + ", " + ac1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public static boolean method554(boolean flag, byte byte0, byte[][] abyte0, byte byte1) {
        try {
            ...
            Signlink.reportError("63814, " + flag + ", " + byte0 + ", " + abyte0 + ", " + byte1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
