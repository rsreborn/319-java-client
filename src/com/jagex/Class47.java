...
public class Class47
{
    ...
    public static Class13_Sub1_Sub2 aClass13_Sub1_Sub2_758;
    ...
    public Class13_Sub1_Sub1_Sub4 method582(int i, int j, boolean flag, int ai[])
    {
        try
        {
            if(!flag)
            ...
            if(class13_sub1_sub1_sub4 == null)
            {
                ...
                {
                    if(!Class13_Sub1_Sub1_Sub4.method266(anIntArray769[k]))
                    {
                        flag1 = true;
                    }
                }
                ...
                Class13_Sub1_Sub1_Sub4 aclass13_sub1_sub1_sub4[] = new Class13_Sub1_Sub1_Sub4[anIntArray769.length];
                for(int l = 0; l < anIntArray769.length; l++)
                {
                    aclass13_sub1_sub1_sub4[l] = Class13_Sub1_Sub1_Sub4.method265((byte)4, anIntArray769[l]);
                }
    ...
    public Class13_Sub1_Sub1_Sub4 method583(int i)
    {
        try
        {
            i = 78 / i;
            ...
            {
                if(!Class13_Sub1_Sub1_Sub4.method266(anIntArray766[j]))
                {
                    flag = true;
                }
            }
            ...
            Class13_Sub1_Sub1_Sub4 aclass13_sub1_sub1_sub4[] = new Class13_Sub1_Sub1_Sub4[anIntArray766.length];
            for(int k = 0; k < anIntArray766.length; k++)
            {
                aclass13_sub1_sub1_sub4[k] = Class13_Sub1_Sub1_Sub4.method265((byte)4, anIntArray766[k]);
            }
    ...
    public void method586(Class13_Sub1_Sub2 class13_sub1_sub2, int i)
    {
        try
        {
            if(i != 26421)
            ...
            do
            {
                ...
                if(j == 1)
                {
                    ...
                    {
                        anIntArray769[k1] = class13_sub1_sub2.readUnsignedShort();
                    }
                } else
                if(j == 2)
                {
                ...
                if(j == 3)
                {
                    aByteArray754 = class13_sub1_sub2.method319(true);
                } else
                if(j == 12)
                {
                ...
                if(j == 13)
                {
                    anInt748 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 14)
                {
                    anInt778 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 17)
                {
                    anInt778 = class13_sub1_sub2.readUnsignedShort();
                    anInt785 = class13_sub1_sub2.readUnsignedShort();
                    anInt773 = class13_sub1_sub2.readUnsignedShort();
                    anInt786 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j >= 30 && j < 40)
                {
                ...
                if(j == 40)
                {
                    ...
                    {
                        anIntArray750[l1] = class13_sub1_sub2.readUnsignedShort();
                        anIntArray783[l1] = class13_sub1_sub2.readUnsignedShort();
                    }
                } else
                if(j == 60)
                {
                    ...
                    {
                        anIntArray766[i2] = class13_sub1_sub2.readUnsignedShort();
                    }
                } else
                if(j == 90)
                {
                    anInt746 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 91)
                {
                    anInt772 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 92)
                {
                    anInt753 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 93)
                {
                    aBoolean752 = false;
                ...
                if(j == 95)
                {
                    anInt756 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 97)
                {
                    anInt771 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 98)
                {
                    anInt745 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 99)
                {
                    aBoolean782 = true;
                ...
                if(j == 102)
                {
                    anInt749 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 103)
                {
                    anInt760 = class13_sub1_sub2.readUnsignedShort();
                } else
                if(j == 106)
                {
                    anInt767 = class13_sub1_sub2.readUnsignedShort();
                    if(anInt767 == 65535)
                    {
                        anInt767 = -1;
                    }
                    anInt764 = class13_sub1_sub2.readUnsignedShort();
                    if(anInt764 == 65535)
                    {
                        anInt764 = -1;
                    }
                    ...
                    {
                        anIntArray751[j2] = class13_sub1_sub2.readUnsignedShort();
    ...
    {
        aClass13_Sub1_Sub2_758 = new Class13_Sub1_Sub2(-351, class1.method149("npc.dat", null));
        Class13_Sub1_Sub2 class13_sub1_sub2 = new Class13_Sub1_Sub2(-351, class1.method149("npc.idx", null));
        anInt775 = class13_sub1_sub2.readUnsignedShort();
