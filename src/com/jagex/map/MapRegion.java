package com.jagex.map;/* com.jagex.Class25 - Decompiled by JODE
...
import com.jagex.renderable.Location;
...
public class MapRegion {
    ...
    public MapRegion(int[][][] is, int i, int i_207_, int i_208_,
                     byte[][][] is_209_) {
        try {
            anInt426 = 99;
            anInt427 = i_207_;
    ...
    public static void method454(int i, int i_20_, CollisionMap collisionMap, int i_21_,
                                 int i_22_, int i_23_, int i_24_, byte i_25_,
                                 Scene scene, int i_26_, int[][][] is) {
        try {
            ...
            if (i_20_ == 22) {
                ...
                if (locationConfig.anInt282 == -1 && locationConfig.anIntArray243 == null)
                    ...
                    class13_sub1_sub1
                            = new Location(i_30_, i_27_, i_29_,
                            i_23_, locationConfig.anInt282,
                            i_28_, true, 22, 29895,
                            i);
                scene.method200(class13_sub1_sub1, i_26_, false, i_32_,
                        i_21_, i_33_, i_24_, i_31_);
                if (locationConfig.aBoolean258 && locationConfig.aBoolean260)
                    collisionMap.method519(i_21_, i_24_, true);
                ...
                if (class13_sub1_sub1 != null) {
                    ...
                    scene.method204(i_36_, i_33_, i_31_, i_24_, i_34_, i_35_,
                            i_21_, 22342, i_32_, i_26_,
                            class13_sub1_sub1);
                }
                if (locationConfig.aBoolean258)
                    collisionMap.method518(i_23_, locationConfig.aBoolean270,
                ...
                if (locationConfig.anInt282 == -1 && locationConfig.anIntArray243 == null)
                    ...
                    class13_sub1_sub1
                            ...
                            i);
                scene.method204(1, i_33_, i_31_, i_24_, 0, 1, i_21_, 22342,
                ...
                scene.method202(class13_sub1_sub1, i_26_, aBoolean407, null,
                        i_24_, i_33_, i_32_, i_31_,
                        anIntArray411[i_23_], 0, i_21_);
                if (locationConfig.aBoolean258)
                    collisionMap.method517(i_21_, i_20_, locationConfig.aBoolean270, i_24_,
                            544, i_23_);
            } else if (i_20_ == 1) {
                Renderable class13_sub1_sub1;
                if (locationConfig.anInt282 == -1 && locationConfig.anIntArray243 == null)
                ...
                Renderable class13_sub1_sub1;
                Renderable class13_sub1_sub1_38_;
                if (locationConfig.anInt282 == -1 && locationConfig.anIntArray243 == null) {
                    class13_sub1_sub1
                ...
                scene.method202(class13_sub1_sub1, i_26_, aBoolean407,
                ...
                if (i_20_ == 4) {
                    ...
                    if (locationConfig.anInt282 == -1
                        ...
                        class13_sub1_sub1
                                ...
                                i_28_, true, 4, 29895,
                                i);
                    scene.method203(i_24_, i_32_, i_33_, i_23_ * 512, i_31_,
                            0, anIntArray411[i_23_], (byte) -122,
                            i_21_, i_26_, class13_sub1_sub1, 0);
                } else if (i_20_ == 5) {
                    int i_42_ = 16;
                    int i_43_ = scene.method220(i_26_, i_24_, i_21_);
                    if (i_43_ > 0)
                        i_42_
                    ...
                    if (locationConfig.anInt282 == -1
                        ...
                        class13_sub1_sub1
                                ...
                                i_28_, true, 4, 29895,
                                i);
                    scene.method203(i_24_, i_32_, i_33_, i_23_, i_31_, 0,
            ...
            Signlink.reportError("3566, " + i + ", " + i_20_ + ", " + collisionMap
                    + ", " + i_21_ + ", " + i_22_ + ", " + i_23_
                    + ", " + i_24_ + ", " + i_25_ + ", " + scene
                    + ", " + i_26_ + ", " + is + ", "
                    + runtimeexception);
    ...
    public static int method460(int i, int i_191_, int i_192_, int i_193_) {
        int i_194_ = (65536 - (Rasterizer3D.anIntArray1635
                [i_192_ * 1024 / i_193_])
                >> 1);
    ...
    public void method453(int i, CollisionMap[] collisionMaps, int i_1_, int i_2_,
                          Scene scene, int i_3_, boolean bool, int i_4_,
            ...
            for (; ; ) {
                ...
                for (; ; ) {
                    ...
                    if (i_13_ == i_3_ && i_12_ >= i && i_12_ < i + 8
                        ...
                        int i_17_
                                = (i_6_
                                + MapUtil.getLocationOffsetY(i_11_ & 0x7, i_12_ & 0x7, locationConfig.anInt259, locationConfig.anInt253, i_1_
                        ));
                        int i_18_
                                = i_2_ + MapUtil.getLocationOffsetX(i_11_ & 0x7, i_12_ & 0x7,
                                locationConfig.anInt259, locationConfig.anInt253,
                                i_1_);
                        if (i_17_ > 0 && i_18_ > 0 && i_17_ < 103
                            ...
                            method463(i_7_, i_15_, i_16_ + i_1_ & 0x3, i_17_,
                                    0, i_5_, collisionMap, scene, i_18_);
                        }
                    }
                }
            }
        } catch (RuntimeException runtimeexception) {
            Signlink.reportError("35204, " + i + ", " + collisionMaps + ", " + i_1_
                    + ", " + i_2_ + ", " + scene + ", " + i_3_
                    + ", " + bool + ", " + i_4_ + ", " + i_5_
                    + ", " + i_6_ + ", " + is + ", "
                    + runtimeexception);
    ...
    public void method455(int i, int i_44_, int i_45_, int i_46_, byte[] is,
                          CollisionMap[] collisionMaps, int i_47_, int i_48_, int i_49_,
                          int i_50_) {
        try {
            for (int i_51_ = 0; i_51_ < 8; i_51_++) {
                for (int i_52_ = 0; i_52_ < 8; i_52_++) {
                    if (i_50_ + i_51_ > 0 && i_50_ + i_51_ < 103
                        ...
                        collisionMaps[i].anIntArrayArray682[i_50_ + i_51_]
                                [i_44_ + i_52_]
                                &= ~0x1000000;
                }
            }
                ...
                for (int i_54_ = 0; i_54_ < 64; i_54_++) {
                    for (int i_55_ = 0; i_55_ < 64; i_55_++) {
                        if (i_53_ == i_45_ && i_54_ >= i_46_
                                ...
                                && i_55_ < i_47_ + 8)
                            method461(0, 0,
                                    i_50_ + MapUtil.getOffsetX(i_54_ & 0x7, i_55_ & 0x7, i_49_
                                    ),
                                    buffer, 27458,
                                    i_44_ + MapUtil.getOffsetY(i_54_ & 0x7, i_55_ & 0x7, i_49_
                                    ),
                                    i, i_49_);
                        else
    ...
    public void method457(boolean bool, byte[] is, CollisionMap[] collisionMaps, int i,
                          Scene scene, int i_68_) {
        try {
            Buffer buffer
                    = new Buffer(is);
            if (!bool) {
            ...
            for (; ; ) {
                ...
                for (; ; ) {
                    ...
                    if (i_80_ > 0 && i_81_ > 0 && i_80_ < 103 && i_81_ < 103) {
                        ...
                        CollisionMap collisionMap = null;
                        if (i_82_ >= 0)
                            collisionMap = collisionMaps[i_82_];
                        method463(i_70_, i_78_, i_79_, i_80_, 0, i_76_,
                                collisionMap, scene, i_81_);
                    }
                }
            }
        } catch (RuntimeException runtimeexception) {
            Signlink.reportError("95150, " + bool + ", " + is + ", " + collisionMaps
                    + ", " + i + ", " + scene + ", " + i_68_
                    + ", " + runtimeexception);
            throw new RuntimeException();
        }
    ...
    public void method458(Scene scene, byte i, CollisionMap[] collisionMaps) {
        try {
                    ...
                    for (int i_85_ = 0; i_85_ < 104; i_85_++) {
                        if ((aByteArrayArrayArray418[i_83_][i_84_][i_85_]
                            ...
                            if ((aByteArrayArrayArray418[1][i_84_][i_85_]
                                ...
                                i_86_--;
                            if (i_86_ >= 0)
                                collisionMaps[i_86_].method519(i_85_, i_84_, true);
                        }
                    }
                }
            }
            ...
            for (int i_87_ = 0; i_87_ < 4; i_87_++) {
                ...
                for (int i_141_ = 1; i_141_ < anInt428 - 1; i_141_++) {
                    for (int i_142_ = 1; i_142_ < anInt427 - 1; i_142_++)
                        scene.method198(i_87_, i_142_, i_141_,
                                method466(i_87_, (byte) 2, i_141_,
                                        i_142_));
                }
            }
            scene.method225(-50, 64, 768, 5227, -50, -10);
            if (i != 6)
                aBoolean434 = !aBoolean434;
            for (int i_143_ = 0; i_143_ < anInt427; i_143_++) {
                for (int i_144_ = 0; i_144_ < anInt428; i_144_++) {
                    if ((aByteArrayArrayArray418[1][i_143_][i_144_] & 0x2)
                            == 2)
                        scene.method196(i_144_, true, i_143_);
                }
            }
            int i_145_ = 1;
            int i_146_ = 2;
                        ...
                        for (int i_151_ = 0; i_151_ <= anInt427; i_151_++) {
                            if (((anIntArrayArrayArray408[i_149_][i_151_]
                                ...
                                if (i_158_ >= 8) {
                                    ...
                                    Scene.method197(i_161_, i_148_, true, 1,
                                            i_152_ * 128,
                                            i_151_ * 128, i_160_,
                                            i_151_ * 128,
                                            i_153_ * 128 + 128);
                            ...
                            if (((anIntArrayArrayArray408[i_149_][i_151_]
                                ...
                                if (i_170_ >= 8) {
                                    ...
                                    Scene.method197(i_173_, i_148_, true, 2,
                                            i_150_ * 128,
                                            i_164_ * 128, i_172_,
                                            i_165_ * 128 + 128,
                                            i_150_ * 128);
                            ...
                            if (((anIntArrayArrayArray408[i_149_][i_151_]
                                ...
                                if ((i_177_ - i_176_ + 1) * (i_179_ - i_178_
                                    ...
                                    Scene.method197(i_182_, i_148_, true, 4,
                                            i_178_ * 128,
                                            i_176_ * 128, i_182_,
                                            i_177_ * 128 + 128,
                                            i_179_ * 128 + 128);
            ...
            Signlink.reportError("80819, " + scene + ", " + i + ", "
                    + collisionMaps + ", "
                ...
                if (i_210_ == 22) {
                    if (!aBoolean433 || locationConfig.aBoolean260
                        ...
                        if (locationConfig.anInt282 == -1
                            ...
                            class13_sub1_sub1
                                    = new Location(i_219_, i_216_,
                                    i_218_, i_211_,
                                    locationConfig.anInt282,
                                    i_217_, true, 22,
                                    29895, i);
                        scene.method200(class13_sub1_sub1, i_214_, false,
                                i_221_, i_215_, i_222_, i_212_,
                                i_220_);
                        if (locationConfig.aBoolean258 && locationConfig.aBoolean260
                                && collisionMap != null)
                            collisionMap.method519(i_215_, i_212_, true);
                    }
                    ...
                    if (class13_sub1_sub1 != null) {
                        ...
                        if (scene.method204(i_225_, i_222_, i_220_, i_212_,
                    ...
                    if (locationConfig.aBoolean258 && collisionMap != null)
                        collisionMap.method518(i_211_, locationConfig.aBoolean270,
                                locationConfig.anInt253, locationConfig.anInt259,
                    ...
                    if (locationConfig.anInt282 == -1
                        ...
                        class13_sub1_sub1
                                ...
                                i_217_, true, i_210_,
                                29895, i);
                    scene.method204(1, i_222_, i_220_, i_212_, 0, 1, i_215_,
                            22342, i_221_, i_214_,
                            class13_sub1_sub1);
                    ...
                    if (locationConfig.anInt282 == -1
                        ...
                        class13_sub1_sub1
                                ...
                                i_217_, true, 0,
                                29895, i);
                    scene.method202(class13_sub1_sub1, i_214_, aBoolean407,
                    ...
                    if (locationConfig.aBoolean258 && collisionMap != null)
                        collisionMap.method517(i_215_, i_210_, locationConfig.aBoolean270,
                                i_212_, 544, i_211_);
                    if (locationConfig.anInt269 != 16)
                        scene.method210(locationConfig.anInt269, 533, i_215_,
                                i_212_, i_214_);
                } else if (i_210_ == 1) {
                    Renderable class13_sub1_sub1;
                    if (locationConfig.anInt282 == -1
                    ...
                    Renderable class13_sub1_sub1;
                    Renderable class13_sub1_sub1_230_;
                    if (locationConfig.anInt282 == -1
                            && locationConfig.anIntArray243 == null) {
                        class13_sub1_sub1
                    ...
                    if (i_210_ == 4) {
                        ...
                        if (locationConfig.anInt282 == -1
                            ...
                            class13_sub1_sub1
                                    ...
                                    i_217_, true, 4,
                                    29895, i);
                        scene.method203(i_212_, i_221_, i_222_, i_211_ * 512,
                                i_220_, 0, anIntArray411[i_211_],
                                (byte) -122, i_215_, i_214_,
                                class13_sub1_sub1, 0);
                    } else if (i_210_ == 5) {
                        int i_234_ = 16;
                        int i_235_ = scene.method220(i_214_, i_212_, i_215_);
                        if (i_235_ > 0)
                        ...
                        if (locationConfig.anInt282 == -1
                            ...
                            class13_sub1_sub1
                                    ...
                                    i_217_, true, 4,
                                    29895, i);
                        scene.method203(i_212_, i_221_, i_222_, i_211_,
    ...
    public void method470(byte[] is, byte i, int i_262_, int i_263_,
                          int i_264_, int i_265_, CollisionMap[] collisionMaps) {
        do {
            try {
                    ...
                    for (int i_267_ = 0; i_267_ < 64; i_267_++) {
                        for (int i_268_ = 0; i_268_ < 64; i_268_++) {
                            if (i_264_ + i_267_ > 0 && i_264_ + i_267_ < 103
                                    && i_265_ + i_268_ > 0
                                    && i_265_ + i_268_ < 103)
                                collisionMaps[i_266_].anIntArrayArray682
