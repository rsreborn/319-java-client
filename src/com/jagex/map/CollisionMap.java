...
public class CollisionMap {
    ...
    public CollisionMap(int i, int j, int k) {
        ...
        try {
            ...
            Signlink.reportError("90336, " + i + ", " + j + ", " + k + ", " + runtimeexception);
        }
    ...
    public void method517(int i, int j, boolean flag, int k, int l, int i1) {
        try {
            ...
            Signlink.reportError("94763, " + i + ", " + j + ", " + flag + ", " + k + ", " + l + ", " + i1 + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }
    ...
    public void method518(int i, boolean flag, int j, int k, int l, byte byte0, int i1) {
        try {
            ...
            Signlink.reportError("54614, " + i + ", " + flag + ", " + j + ", " + k + ", " + l + ", " + byte0 + ", " + i1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public void method519(int i, int j, boolean flag) {
        try {
            ...
            Signlink.reportError("30201, " + i + ", " + j + ", " + flag + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public void method521(boolean flag, int i, int j, int k, int l, boolean flag1) {
        try {
            ...
            Signlink.reportError("62320, " + flag + ", " + i + ", " + j + ", " + k + ", " + l + ", " + flag1 + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }
    ...
    public void method522(int i, int j, int k, boolean flag, int l, int i1, int j1) {
        try {
            ...
            Signlink.reportError("85000, " + i + ", " + j + ", " + k + ", " + flag + ", " + l + ", " + i1 + ", " + j1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public void method523(int i, int j, int k, boolean flag) {
        try {
            ...
            Signlink.reportError("2471, " + i + ", " + j + ", " + k + ", " + flag + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }
    ...
    public void method524(int i, boolean flag, int j) {
        try {
            ...
            Signlink.reportError("933, " + i + ", " + flag + ", " + j + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public boolean method525(int i, int j, int k, int l, int i1, int j1, int k1) {
        try {
            ...
            if (k1 == 9) {
                ...
                return l == i + 1 && j == k && (anIntArrayArray682[l][j] & 0x80) == 0;
            }
            return false;
        } catch (RuntimeException runtimeexception) {
            Signlink.reportError("50749, " + i + ", " + j + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + k1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public boolean method526(int i, int j, int k, int l, int i1, int j1, boolean flag) {
        try {
            ...
            if (l == 8) {
                ...
                return j == i + 1 && i1 == j1 && (anIntArrayArray682[j][i1] & 0x80) == 0;
            }
            return false;
        } catch (RuntimeException runtimeexception) {
            Signlink.reportError("81672, " + i + ", " + j + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + flag + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public boolean method527(int i, int j, int k, int l, int i1, int j1, int k1,
        ...
        try {
            ...
            Signlink.reportError("93475, " + i + ", " + j + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + k1 + ", " + l1 + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
}
