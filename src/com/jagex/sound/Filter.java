...
public class Filter {
    ...
    public float method485(float f, int i, int j, int k) {
        try {
            ...
            Signlink.reportError("17456, " + f + ", " + i + ", " + j + ", " + k + ", " + runtimeexception);
        }
    ...
    public float method486(float f, boolean flag) {
        try {
            ...
            Signlink.reportError("14901, " + f + ", " + flag + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public float method487(int i, float f, int j, int k) {
        try {
            ...
            Signlink.reportError("64420, " + i + ", " + f + ", " + j + ", " + k + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
    ...
    public int method488(int i, int j, float f) {
        try {
            ...
            Signlink.reportError("12887, " + i + ", " + j + ", " + f + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }

    public void method489(Envelope envelope, int i, Buffer buffer) {
        try {
            ...
            if (j != 0) {
                ...
                if (k != 0 || anIntArray468[1] != anIntArray468[0]) {
                    envelope.method182(buffer, false);
                }
                return;
            } else {
            ...
            Signlink.reportError("23814, " + envelope + ", " + i + ", " + buffer + ", " + runtimeexception);
        }
        throw new RuntimeException();
    }
