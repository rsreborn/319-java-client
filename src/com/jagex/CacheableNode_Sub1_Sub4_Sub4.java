...
public class CacheableNode_Sub1_Sub4_Sub4 extends CacheableNode_Sub1_Sub4 {
    ...
    public CacheableNode_Sub1_Sub4_Sub4(int i, int j) {
        anInt1675 = 47637;
        aBoolean1676 = false;
        aByte1677 = 6;
        anInt1678 = 834;
    ...
    public CacheableNode_Sub1_Sub4_Sub4(byte[] abyte0, Component component) {
        anInt1675 = 47637;
        aBoolean1676 = false;
        aByte1677 = 6;
        anInt1678 = 834;
    ...
    public CacheableNode_Sub1_Sub4_Sub4(CacheArchive cacheArchive, String s, int i) {
        anInt1675 = 47637;
        aBoolean1676 = false;
        aByte1677 = 6;
        anInt1678 = 834;
    ...
    public void method403(boolean flag) {
        try {
            ...
            CacheableNode_Sub1_Sub4.method351(0, anIntArray1680, anInt1682, anInt1681);
            return;
    ...
    public void method406(int i, int j, int k) {
        try {
            i += anInt1683;
            j += anInt1684;
            int l = i + j * CacheableNode_Sub1_Sub4.anInt1424;
            int i1 = 0;
            int j1 = anInt1682;
            int k1 = anInt1681;
            int l1 = CacheableNode_Sub1_Sub4.anInt1424 - k1;
            int i2 = 0;
            if (j < CacheableNode_Sub1_Sub4.anInt1426) {
                ...
                i1 += j2 * k1;
                l += j2 * CacheableNode_Sub1_Sub4.anInt1424;
            }
            if (j + j1 > CacheableNode_Sub1_Sub4.anInt1427) {
                j1 -= (j + j1) - CacheableNode_Sub1_Sub4.anInt1427;
            }
            ...
            if (i + k1 > CacheableNode_Sub1_Sub4.anInt1429) {
                int l2 = (i + k1) - CacheableNode_Sub1_Sub4.anInt1429;
                k1 -= l2;
                i2 += l2;
                l1 += l2;
            }
            ...
            method407(l, i2, l1, j1, k1, i1, anIntArray1680, 5, CacheableNode_Sub1_Sub4.anIntArray1423);
            if (k <= 0) {
                anInt1678 = 287;
                return;
            }
    ...
    public void method408(int i, byte byte0, int j) {
        try {
            ...
            i += anInt1684;
            int l = j + i * CacheableNode_Sub1_Sub4.anInt1424;
            int i1 = 0;
            int j1 = anInt1682;
            int k1 = anInt1681;
            int l1 = CacheableNode_Sub1_Sub4.anInt1424 - k1;
            ...
            if (i < CacheableNode_Sub1_Sub4.anInt1426) {
                int j2 = CacheableNode_Sub1_Sub4.anInt1426 - i;
                j1 -= j2;
                i = CacheableNode_Sub1_Sub4.anInt1426;
                i1 += j2 * k1;
                l += j2 * CacheableNode_Sub1_Sub4.anInt1424;
            }
            if (i + j1 > CacheableNode_Sub1_Sub4.anInt1427) {
                j1 -= (i + j1) - CacheableNode_Sub1_Sub4.anInt1427;
            }
            if (j < CacheableNode_Sub1_Sub4.anInt1428) {
                int k2 = CacheableNode_Sub1_Sub4.anInt1428 - j;
                k1 -= k2;
            ...
            if (j + k1 > CacheableNode_Sub1_Sub4.anInt1429) {
                int l2 = (j + k1) - CacheableNode_Sub1_Sub4.anInt1429;
                k1 -= l2;
                i2 += l2;
                l1 += l2;
            }
            if (k1 <= 0 || j1 <= 0) {
                ...
                method409(CacheableNode_Sub1_Sub4.anIntArray1423, anIntArray1680, 0, i1, l, k1, j1, l1, i2);
                return;
            }
        } catch (RuntimeException runtimeexception) {
    ...
    public void method410(int i, int j, int k, int l) {
        try {
            i += anInt1683;
            l += anInt1684;
            int i1 = i + l * CacheableNode_Sub1_Sub4.anInt1424;
            int j1 = 0;
            if (j < 8 || j > 8) {
            ...
            int l1 = anInt1682;
            int i2 = anInt1681;
            int j2 = CacheableNode_Sub1_Sub4.anInt1424 - i2;
            int k2 = 0;
            if (l < CacheableNode_Sub1_Sub4.anInt1426) {
                int l2 = CacheableNode_Sub1_Sub4.anInt1426 - l;
                l1 -= l2;
                l = CacheableNode_Sub1_Sub4.anInt1426;
                j1 += l2 * i2;
                i1 += l2 * CacheableNode_Sub1_Sub4.anInt1424;
            }
            if (l + l1 > CacheableNode_Sub1_Sub4.anInt1427) {
                l1 -= (l + l1) - CacheableNode_Sub1_Sub4.anInt1427;
            }
            if (i < CacheableNode_Sub1_Sub4.anInt1428) {
                int i3 = CacheableNode_Sub1_Sub4.anInt1428 - i;
                i2 -= i3;
                i = CacheableNode_Sub1_Sub4.anInt1428;
                j1 += i3;
                i1 += i3;
            ...
            if (i + i2 > CacheableNode_Sub1_Sub4.anInt1429) {
                int j3 = (i + i2) - CacheableNode_Sub1_Sub4.anInt1429;
                i2 -= j3;
                k2 += j3;
                j2 += j3;
            }
            if (i2 <= 0 || l1 <= 0) {
                ...
                method411(true, i2, l1, anIntArray1680, j2, k2, k, 0, i1, CacheableNode_Sub1_Sub4.anIntArray1423, j1);
                return;
            }
        } catch (RuntimeException runtimeexception) {
    ...
    public void method412(int[] ai, int[] ai1, int i, int j, int k, int l, int i1,
        ...
        try {
            ...
            try {
                ...
                int l3 = k + l1 * CacheableNode_Sub1_Sub4.anInt1424;
                for (l1 = 0; l1 < i; l1++) {
                    int i4 = ai[l1];
                    int j4 = l3 + i4;
                    int k4 = j3 + i3 * i4;
                    int l4 = k3 - l2 * i4;
                    for (k = -ai1[l1]; k < 0; k++) {
                        CacheableNode_Sub1_Sub4.anIntArray1423[j4++] = anIntArray1680[(k4 >> 16) + (l4 >> 16) * anInt1681];
                        k4 += i3;
                        l4 -= l2;
                    }
                    j3 += l2;
                    k3 += i3;
                    l3 += CacheableNode_Sub1_Sub4.anInt1424;
                }
                return;
            } catch (Exception _ex) {
                return;
    ...
    public void method413(int i, int j, int k, int l, int i1, double d,
        ...
        try {
            ...
            try {
                ...
                int j3 = k1 + j1 * CacheableNode_Sub1_Sub4.anInt1424;
                for (j1 = 0; j1 < i1; j1++) {
                    int k3 = j3;
                    int l3 = l2;
                    int i4 = i3;
                    for (k1 = -j; k1 < 0; k1++) {
                        ...
                        if (j4 != 0) {
                            CacheableNode_Sub1_Sub4.anIntArray1423[k3++] = j4;
                        } else {
                            k3++;
                        }
                        l3 += k2;
                    ...
                    l2 += j2;
                    i3 += k2;
                    j3 += CacheableNode_Sub1_Sub4.anInt1424;
                }
                return;
            } catch (Exception _ex) {
                return;
    ...
    public void method414(int i, int j, CacheableNode_Sub1_Sub4_Sub3 class13_sub1_sub4_sub3, byte byte0) {
        try {
            j += anInt1683;
            i += anInt1684;
            ...
            if (j1 <= 0 || i1 <= 0) {
                ...
                method415(l, 0, class13_sub1_sub4_sub3.aByteArray1667, i1, 381, l1, k, k1, j1, anIntArray1680, CacheableNode_Sub1_Sub4.anIntArray1423);
                return;
            }
        } catch (RuntimeException runtimeexception) {
