...
public class Font extends Rasterizer {
    ...
    public void method392(byte[] abyte0, int i, int j, int k, int l, int i1) {
        ...
        if (i + k >= Rasterizer.anInt1429) {
            int l2 = ((i + k) - Rasterizer.anInt1429) + 1;
            k -= l2;
            l1 += l2;
            k1 += l2;
        }
    ...
    public void method394(int i, int j, byte byte0, int k, int l, byte[] abyte0, int i1,
        ...
        try {
            ...
            if (j + k >= Rasterizer.anInt1429) {
                int i3 = ((j + k) - Rasterizer.anInt1429) + 1;
                k -= i3;
                i2 += i3;
                l1 += i3;
            }
