...
public class ProducingGraphicsBuffer implements ImageProducer, ImageObserver {
    ...
    public ProducingGraphicsBuffer(boolean flag, int i, Component component, int j) {
        aBoolean480 = true;
        anInt481 = -22144;
        try {
            anInt483 = i;
            ...
            Signlink.reportError("13339, " + flag + ", " + i + ", " + component + ", " + j + ", " + runtimeexception);
        }
    ...
    public void method490(boolean flag) {
        try {
            ...
            Rasterizer.method351(0, anIntArray482, anInt484, anInt483);
            return;
        } catch (RuntimeException runtimeexception) {
    ...
    public void method491(Graphics g, int i, boolean flag, int j) {
        try {
            ...
            Signlink.reportError("63280, " + g + ", " + i + ", " + flag + ", " + j + ", " + runtimeexception);
            throw new RuntimeException();
        }
    }
