...
public class Class32
{
    ...
    public static void method493(Class1 class1, byte byte0)
    {
        try
        {
            ...
            for(int i = 0; i < anInt488; i++)
            {
                ...
                aClass32Array489[i].method494(class13_sub1_sub2, 26421);
            }
            return;
        }
        catch(RuntimeException runtimeexception)
        {
            signlink.reportError("75176, " + class1 + ", " + byte0 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }

    public void method494(Class13_Sub1_Sub2 class13_sub1_sub2, int i)
    {
        try
        {
            if(i != 26421)
            ...
            do
            {
                ...
                if(j == 1)
                {
                    anInt491 = class13_sub1_sub2.method315();
                ...
                if(j == 7)
                {
                    ...
                    int i1 = anInt497;
                    int j1 = anInt498;
                    int k1 = class13_sub1_sub2.method315();
        ...
        {
            signlink.reportError("47725, " + class13_sub1_sub2 + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method495(byte byte0, int i)
    {
        ...
        {
            signlink.reportError("92653, " + byte0 + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
