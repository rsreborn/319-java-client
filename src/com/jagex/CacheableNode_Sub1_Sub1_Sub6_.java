        ...
        try {
            ...
            if (aNpcConfig_1716 != null) {
                ...
                if (super.anInt1597 >= 0 && super.anInt1600 == 0) {
                    j = SeqConfig.aSeqConfigArray800[super.anInt1597].anIntArray802[super.anInt1598];
                } else if (super.anInt1620 >= 0) {
                    j = SeqConfig.aSeqConfigArray800[super.anInt1620].anIntArray802[super.anInt1621];
                }
            ...
            int k1 = -1;
            if (super.anInt1597 >= 0 && super.anInt1600 == 0) {
                SeqConfig seqConfig = SeqConfig.aSeqConfigArray800[super.anInt1597];
                k = seqConfig.anIntArray802[super.anInt1598];
                if (super.anInt1620 >= 0 && super.anInt1620 != super.anInt1584) {
                    i1 = SeqConfig.aSeqConfigArray800[super.anInt1620].anIntArray802[super.anInt1621];
                }
                if (seqConfig.anInt809 >= 0) {
                    j1 = seqConfig.anInt809;
                    l += j1 - anIntArray1703[5] << 40;
                }
                if (seqConfig.anInt810 >= 0) {
                    k1 = seqConfig.anInt810;
            ...
            if (class13_sub1_sub1_sub4_1 == null) {
                ...
                for (int l1 = 0; l1 < 12; l1++) {
                    ...
                    if (j2 >= 256 && j2 < 512 && !IdkConfig.aIdkConfigArray65[j2 - 256].method177(true)) {
                        flag = true;
                    }
                    if (j2 >= 512 && !ObjConfig.method505(j2 - 512).method504((byte) 9, anInt1687)) {
                        flag = true;
                    }
                }
                if (flag) {
            ...
            if (class13_sub1_sub1_sub4_1 == null) {
                ...
                for (int k2 = 0; k2 < 12; k2++) {
                    ...
                    if (l2 >= 256 && l2 < 512) {
                        Model class13_sub1_sub1_sub4_3 = IdkConfig.aIdkConfigArray65[l2 - 256].method178(0);
                        if (class13_sub1_sub1_sub4_3 != null) {
                            aclass13_sub1_sub1_sub4[i2++] = class13_sub1_sub1_sub4_3;
                        }
                    }
                    if (l2 >= 512) {
                        Model class13_sub1_sub1_sub4_4 = ObjConfig.method505(l2 - 512).method507(4, anInt1687);
            ...
            if (k != -1 && i1 != -1) {
                class13_sub1_sub1_sub4_2.method274(aByte1708, SeqConfig.aSeqConfigArray800[super.anInt1597].anIntArray806, i1, k);
            } else if (k != -1) {
    ...
    public Model method296(int i) {
        try {
            ...
            for (int j = 0; j < 12; j++) {
                ...
                if (k >= 256 && k < 512 && !IdkConfig.aIdkConfigArray65[k - 256].method179(-1743)) {
                    flag = true;
                }
                if (k >= 512 && !ObjConfig.method505(k - 512).method506(5, anInt1687)) {
                    flag = true;
                }
            }
            if (flag) {
            ...
            for (int i1 = 0; i1 < 12; i1++) {
                ...
                if (j1 >= 256 && j1 < 512) {
                    Model class13_sub1_sub1_sub4_1 = IdkConfig.aIdkConfigArray65[j1 - 256].method180(aByte1690);
                    if (class13_sub1_sub1_sub4_1 != null) {
                        aclass13_sub1_sub1_sub4[l++] = class13_sub1_sub1_sub4_1;
                    }
                }
                if (j1 >= 512) {
                    Model class13_sub1_sub1_sub4_2 = ObjConfig.method505(j1 - 512).method512(anInt1687, (byte) -34);
    ...
    public Model method256(int i) {
        try {
            ...
            if (super.anInt1592 != -1 && super.anInt1593 != -1) {
                ...
                Model class13_sub1_sub1_sub4_2 = spotAnimConfig.method530();
                if (class13_sub1_sub1_sub4_2 != null) {
                    ...
                    class13_sub1_sub1_sub4_3.method273(spotAnimConfig.aSeqConfig_689.anIntArray802[super.anInt1593], false);
                    ...
                    if (spotAnimConfig.anInt692 != 128 || spotAnimConfig.anInt693 != 128) {
                        class13_sub1_sub1_sub4_3.method281(spotAnimConfig.anInt692, spotAnimConfig.anInt692, spotAnimConfig.anInt693, (byte) 0);
                    }
                    class13_sub1_sub1_sub4_3.method282(64 + spotAnimConfig.anInt695, 850 + spotAnimConfig.anInt696, -30, -50, -30, true);
    ...
    public void method297(Buffer buffer, int i) {
        try {
            ...
            for (int j = 0; j < 12; j++) {
                ...
                if (anIntArray1703[j] >= 512 && anIntArray1703[j] - 512 < ObjConfig.anInt669) {
                    int l1 = ObjConfig.method505(anIntArray1703[j] - 512).anInt641;
                    if (l1 != 0) {
                        anInt1702 = l1;
                    }
                }
