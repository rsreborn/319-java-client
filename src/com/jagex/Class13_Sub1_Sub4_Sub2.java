...
public class Class13_Sub1_Sub4_Sub2 extends Class13_Sub1_Sub4
{
    ...
    public Class13_Sub1_Sub4_Sub2(String s, Class1 class1, boolean flag, int i)
    {
        ...
        {
            signlink.reportError("91897, " + s + ", " + class1 + ", " + flag + ", " + i + ", " + runtimeexception.toString());
        }
    ...
    public void method380(int i, boolean flag, String s, int j, int k)
    {
        ...
        {
            signlink.reportError("82776, " + i + ", " + flag + ", " + s + ", " + j + ", " + k + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method381(int i, int j, int k, int l, String s)
    {
        ...
        {
            signlink.reportError("91627, " + i + ", " + j + ", " + k + ", " + l + ", " + s + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method382(int i, boolean flag, String s, int j, int k, boolean flag1)
    {
        ...
        {
            signlink.reportError("84269, " + i + ", " + flag + ", " + s + ", " + j + ", " + k + ", " + flag1 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public int method383(int i, String s)
    {
        ...
        {
            signlink.reportError("71598, " + i + ", " + s + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public int method384(String s, int i)
    {
        ...
        {
            signlink.reportError("10623, " + s + ", " + i + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method385(byte byte0, String s, int i, int j, int k)
    {
        ...
        {
            signlink.reportError("36940, " + byte0 + ", " + s + ", " + i + ", " + j + ", " + k + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method386(int i, int j, int k, int l, int i1, String s)
    {
        ...
        {
            signlink.reportError("95818, " + i + ", " + j + ", " + k + ", " + l + ", " + i1 + ", " + s + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method387(int i, int j, String s, int k, int l, int i1)
    {
        ...
        {
            signlink.reportError("53445, " + i + ", " + j + ", " + s + ", " + k + ", " + l + ", " + i1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
    ...
    public void method388(int i, String s, int j, int k, int l, int i1, int j1)
    {
        ...
        {
            signlink.reportError("78800, " + i + ", " + s + ", " + j + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method389(boolean flag, int i, byte byte0, int j, int k, String s)
    {
        try
        {
            ...
            if(aBoolean1661)
            {
                Class13_Sub1_Sub4.method359((byte)-40, 0x800000, l, j + (int)((double)anInt1659 * 0.69999999999999996D), i - l);
                return;
            }
        }
        catch(RuntimeException runtimeexception)
        {
            signlink.reportError("12006, " + flag + ", " + i + ", " + byte0 + ", " + j + ", " + k + ", " + s + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
    ...
    public void method390(boolean flag, int i, int j, int k, int l, String s, int i1)
    {
        ...
        {
            signlink.reportError("10204, " + flag + ", " + i + ", " + j + ", " + k + ", " + l + ", " + s + ", " + i1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
    ...
    public int method391(int i, String s)
    {
        ...
        {
            signlink.reportError("44527, " + i + ", " + s + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    {
        int j1 = i + j * Class13_Sub1_Sub4.anInt1424;
        int k1 = Class13_Sub1_Sub4.anInt1424 - k;
        int l1 = 0;
        int i2 = 0;
        if(j < Class13_Sub1_Sub4.anInt1426)
        {
            ...
            i2 += j2 * k;
            j1 += j2 * Class13_Sub1_Sub4.anInt1424;
        }
        if(j + l >= Class13_Sub1_Sub4.anInt1427)
        {
            l -= ((j + l) - Class13_Sub1_Sub4.anInt1427) + 1;
        }
        ...
        if(i + k >= Class13_Sub1_Sub4.anInt1429)
        {
            int l2 = ((i + k) - Class13_Sub1_Sub4.anInt1429) + 1;
            k -= l2;
            l1 += l2;
            k1 += l2;
        }
        ...
        {
            method393(Class13_Sub1_Sub4.anIntArray1423, abyte0, i1, i2, j1, k, l, k1, l1);
            return;
        }
    }
            ...
            int j1)
    {
        try
        {
            int k1 = j + l * Class13_Sub1_Sub4.anInt1424;
            int l1 = Class13_Sub1_Sub4.anInt1424 - k;
            int i2 = 0;
            int j2 = 0;
            if(l < Class13_Sub1_Sub4.anInt1426)
            {
                int k2 = Class13_Sub1_Sub4.anInt1426 - l;
                j1 -= k2;
                l = Class13_Sub1_Sub4.anInt1426;
                j2 += k2 * k;
                k1 += k2 * Class13_Sub1_Sub4.anInt1424;
            }
            if(l + j1 >= Class13_Sub1_Sub4.anInt1427)
            {
                j1 -= ((l + j1) - Class13_Sub1_Sub4.anInt1427) + 1;
            }
            if(j < Class13_Sub1_Sub4.anInt1428)
            {
                int l2 = Class13_Sub1_Sub4.anInt1428 - j;
                k -= l2;
            ...
            if(j + k >= Class13_Sub1_Sub4.anInt1429)
            {
                int i3 = ((j + k) - Class13_Sub1_Sub4.anInt1429) + 1;
                k -= i3;
                i2 += i3;
                l1 += i3;
            }
            ...
            method395(i1, 0, i2, k, l1, j1, Class13_Sub1_Sub4.anIntArray1423, i, j2, abyte0, k1);
            if(byte0 != 9)
            {
        ...
        {
            signlink.reportError("21887, " + i + ", " + j + ", " + byte0 + ", " + k + ", " + l + ", " + abyte0 + ", " + i1 + ", " + j1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
            ...
            int k1, int l1, byte abyte0[], int i2)
    {
        ...
        {
            signlink.reportError("48386, " + i + ", " + j + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + ai + ", " + k1 + ", " + l1 + ", " + abyte0 + ", " + i2 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
}
